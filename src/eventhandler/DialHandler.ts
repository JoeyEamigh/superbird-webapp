...
const reactToDial = (hardwareEvents: HardwareEvents, rootStore: RootStore) => {
      ...
      switch (viewStore.currentView) {
        ...
        case View.TRACKLIST:
          if (tracklistStore.tracklistUiState.selectedItem) {
            ...
            tracklistStore.tracklistUiState.handleItemSelected(tracklistStore.tracklistUiState.selectedItem, id);
          }
          break;
        case View.QUEUE:
  ...
  const handleDialLongPress = action(() => {
    ...
    } else if (viewStore.isTracklist && tracklistStore.tracklistUiState.selectedItem) {
      tracklistStore.tracklistUiState.handleAddToQueue(tracklistStore.tracklistUiState.selectedItem);
      ...
      switch (viewStore.currentView) {
        ...
        case View.TRACKLIST:
          ...
          if (tracklistStore.tracklistUiState.leftItem) {
            tracklistStore.tracklistUiState.updateSelectedItem(tracklistStore.tracklistUiState.leftItem);
          }
          break;
        case View.QUEUE:
      ...
      switch (viewStore.currentView) {
        ...
        case View.TRACKLIST:
          ...
          if (tracklistStore.tracklistUiState.rightItem) {
            tracklistStore.tracklistUiState.updateSelectedItem(tracklistStore.tracklistUiState.rightItem);
          }
          break;
        case View.QUEUE:
