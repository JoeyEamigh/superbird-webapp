...
const reactToBackButton = (hardwareEvents: HardwareEvents, rootStore: RootStore) => {
  const { overlayController, viewStore, npvStore, tracklistStore, shelfStore, onboardingStore, ubiLogger, queueStore } =
    rootStore;
      ...
      switch (viewStore.currentView) {
        ...
        case View.TRACKLIST:
          ...
          if (
            ...
            ubiLogger.trackListUbiLogger.logBackButtonPressed(tracklistStore.tracklistUiState.contextUri);
            viewStore.back();
          }
          break;
        case View.QUEUE:
