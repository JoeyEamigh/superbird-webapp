...
const errorHandler = new ErrorHandler(interappActions, backtrace, [no_wamp_session_destroyed], isProduction);

window.addEventListener('error', console.error);
window.addEventListener('unhandledrejection', console.error);

// Setup mobx stores
const rootStore = new RootStore(interappActions, middlewareActions, middlewareStorage, socket, errorHandler);
