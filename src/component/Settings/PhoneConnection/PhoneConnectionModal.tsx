    ...
    switch (phoneConnectionStore.phoneConnectionModal) {
          ...
          <>
            ...
            <div className={styles.description}>
              {`Go to Bluetooth in your phone’s settings and connect to ${
                bluetoothStore.localDevice ? bluetoothStore.localDevice.name : 'your Car Thing'
              }.`}
            </div>
          </>
        );
      case PhoneConnectionModalView.ADD_NEW_PAIRING:
        return (
          <>
            ...
            <div className={styles.description}>Confirm that you see the code below on your phone.</div>
      ...
      case PhoneConnectionModalView.FORGET_PHONE_PROGRESS:
        return (
          <>
            ...
            <div className={styles.subtitle} data-testid="forget-phone-progress">
              <p>Forgetting</p>
      ...
      case PhoneConnectionModalView.SELECT_PHONE_PROGRESS:
        return (
          <>
            <Spinner size={SpinnerSize.BIG} />
            <div className={styles.subtitle} data-testid="select-phone-progress">
              <p>Connecting to</p>
              <p>{phoneConnectionStore.phoneToConnectOrForget?.name}...</p>
            </div>
          </>
      ...
      case PhoneConnectionModalView.SELECT_PHONE_FAILURE:
        return (
          <>
            ...
            <div className={styles.description}>
              <p>
                Car Thing is having trouble connecting to your phone. Make sure your phone is turned on, Bluetooth is on
                and in range.
              </p>
            </div>
          </>
