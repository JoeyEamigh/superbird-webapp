...
const PhoneConnectionItem = ({ phoneName, phoneAddress, isActive, isConnected, isConnecting }: Props) => {
  ...
  const displayConnectionStatus = phoneConnectionStore.getPhoneConnectionDisplayStatus(device);
