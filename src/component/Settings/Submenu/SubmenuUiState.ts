...
import SettingsStore, { AboutMenuItemId, OptionsMenuItemId, View } from 'store/SettingsStore';
  ...
  return makeAutoObservable(
    {
      ...
      handleSubmenuItemSelected(item: View): void {
        const { remoteControlStore, permissionsStore } = settingsStore.rootStore;
        const onlyOfflineSettings = !remoteControlStore.interappConnected || permissionsStore.canUseCarThing === false;
