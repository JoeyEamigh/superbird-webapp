...
const PhoneCalls = () => {
  ...
  useEffect(() => {
    const onTouchEnd = () => {
      ...
      if (scrollElement) {
        uiState.setPhoneCallsScrollStep((scrollElement.scrollTop / CONTENT_HEIGHT) * NUMBER_OF_SCROLL_STEPS);
      }
    };
    ...
    const onScroll = () => {
      const scrollElement = containerRef.current;
      if (scrollElement) {
        const hitToBottom = scrollElement.scrollTop === scrollElement.scrollHeight - scrollElement.offsetHeight;
        if (hitToBottom) {
          uiState.setPhoneCallsScrollStep((scrollElement.scrollTop / CONTENT_HEIGHT) * NUMBER_OF_SCROLL_STEPS);
        }
      }
    ...
    <>
      ...
      <div ref={containerRef} className={styles.scrollContainer}>
        <div className={styles.submenuItemWrapper}>
          <SubmenuItem active={uiState.isNotificationStep} item={uiState.phoneCallsSubmenuItem} />
        </div>
        <div className={styles.text}>
          <Type name="celloBook">
            If turned on, you’ll see your incoming and outgoing phone call info on your screen and will be able to
            answer or decline calls. Be sure your phone is connected to the car's speakers and microphone.
            <br />
            <br />
            If your phone can’t be connected to the car’s microphone, place your phone close enough to use the phone’s
            microphone.
          </Type>
        </div>
      </div>
