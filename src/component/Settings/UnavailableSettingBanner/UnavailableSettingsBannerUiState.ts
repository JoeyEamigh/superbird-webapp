...
export type UnavailableSettingsBannerUiState = ReturnType<typeof createUnavailableSettingsBannerUiState>;

const createUnavailableSettingsBannerUiState = (settingsUbiLogger: SettingsUbiLogger) => {
