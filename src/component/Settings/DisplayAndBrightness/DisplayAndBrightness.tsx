  ...
  return (
    <>
      <div className={styles.header}>
        <span data-testid={`${OptionsMenuItemId.DISPLAY_AND_BRIGHTNESS}-header`}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <Type name="canonBold" textColor={uiState.isNightMode && greenLight} dataTestId="night-mode-toggle">
            {uiState.isNightMode ? 'On' : 'Off'}
          </Type>
        </div>
        <Type name="celloBook" className={styles.text}>
          With night mode on, your screen should be easier to view in low-light conditions.
        </Type>
      </div>
    </>
  );
