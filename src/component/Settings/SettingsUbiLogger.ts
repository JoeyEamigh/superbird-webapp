...
class SettingsUbiLogger {
  ...
  constructor(ubiLogger: UbiLogger) {
    ...
    this.carSettingsCarthingosEventFactory = createCarSettingsCarthingosEventFactory();
  }
  ...
  logSettingsButtonShow = () => {
    const event = this.carSettingsCarthingosEventFactory.hardwareSettingsButtonFactory().keyStrokeUiReveal();
    this.ubiLogger.logInteraction(event);
  };

  logSettingsButtonHide = () => {
    const event = this.carSettingsCarthingosEventFactory.hardwareSettingsButtonFactory().keyStrokeUiHide();
    this.ubiLogger.logInteraction(event);
  };

  logMainMenuBackButton = () => {
    const event = this.carSettingsCarthingosEventFactory.hardwareBackButtonFactory().keyStrokeUiNavigateBack();
    this.ubiLogger.logInteraction(event);
  };

  logMicClickEnable = () => {
    const event = this.carSettingsCarthingosEventFactory.microphoneRowFactory().hitSettingEnable();
    this.ubiLogger.logInteraction(event);
  };

  logMicClickDisable = () => {
    const event = this.carSettingsCarthingosEventFactory.microphoneRowFactory().hitSettingDisable();
    this.ubiLogger.logInteraction(event);
  };

  logMicDialPressedEnable = () => {
    const event = this.carSettingsCarthingosEventFactory.microphoneRowFactory().keyStrokeSettingEnable();
    this.ubiLogger.logInteraction(event);
  };

  logMicDialPressedDisable = () => {
    const event = this.carSettingsCarthingosEventFactory.microphoneRowFactory().keyStrokeSettingDisable();
    this.ubiLogger.logInteraction(event);
  };

  logPhoneConnectionRowClicked = () => {
    const event = this.carSettingsCarthingosEventFactory.phoneConnectionRowFactory().hitUiNavigate({
  ...
  logPhoneConnectionRowDialPressed = () => {
    const event = this.carSettingsCarthingosEventFactory.phoneConnectionRowFactory().keyStrokeUiNavigate({
      destination: MainMenuItemId.PHONE_CONNECTION,
    });
    this.ubiLogger.logInteraction(event);
  };
  ...
  logAboutRowClicked = () => {
    const event = this.carSettingsCarthingosEventFactory.aboutRowFactory().hitUiNavigate({
  ...
  logAboutRowDialPressed = () => {
    const event = this.carSettingsCarthingosEventFactory.aboutRowFactory().keyStrokeUiNavigate({
      destination: MainMenuItemId.ABOUT,
    });
    this.ubiLogger.logInteraction(event);
  };
  ...
  logOptionsRowClicked = () => {
    const event = this.carSettingsCarthingosEventFactory.optionsRowFactory().hitUiNavigate({
  ...
  logOptionsRowDialPressed = () => {
    const event = this.carSettingsCarthingosEventFactory.optionsRowFactory().keyStrokeUiNavigate({
      destination: MainMenuItemId.OPTIONS,
    });
    this.ubiLogger.logInteraction(event);
  };
  ...
  logRestartRowClicked = () => {
    const event = this.carSettingsCarthingosEventFactory.restartRowFactory().hitUiNavigate({
  ...
  logRestartRowDialPressed = () => {
    const event = this.carSettingsCarthingosEventFactory.restartRowFactory().keyStrokeUiNavigate({
      destination: MainMenuItemId.RESTART,
    });
    this.ubiLogger.logInteraction(event);
  };
  ...
  logUnavailableSettingBannerImpression = () => {
    const event = this.carSettingsCarthingosEventFactory.unavailableSettingBannerFactory().impression();
    this.ubiLogger.logImpression(event);
  };
  ...
  logOptionsViewImpression = () => {
    const event = this.carSettingsCarthingosEventFactory.optionsRowFactory().optionsViewFactory().impression();
    this.ubiLogger.logImpression(event);
  };
  ...
  logTipsOnDemandRowDialPress = () =>
    this.ubiLogger.logInteraction(this.carSettingsCarthingosEventFactory.tipsRowFactory().keyStrokeUiReveal());

  logTipsOnDemandRowTouch = () =>
    this.ubiLogger.logInteraction(this.carSettingsCarthingosEventFactory.tipsRowFactory().hitUiReveal());
  ...
  logTipsOnDemandNextButtonClick = () =>
    this.ubiLogger.logInteraction(
      this.carSettingsCarthingosEventFactory.tipsRowFactory().nextButtonFactory().hitShowTooltip(),
    );
  ...
  logTipsOnDemandBackButton = () =>
    this.ubiLogger.logInteraction(
      this.carSettingsCarthingosEventFactory.tipsRowFactory().backButtonFactory().keyStrokeUiHide(),
    );

  logTipsOnDemandErrorImpression = () =>
    this.ubiLogger.logImpression(
      this.carSettingsCarthingosEventFactory.tipsRowFactory().tipsErrorViewFactory().impression(),
    );

  logTipsOnDemandErrorConfirmation = () =>
    this.ubiLogger.logInteraction(
      this.carSettingsCarthingosEventFactory.tipsRowFactory().tipsErrorViewFactory().okButtonFactory().hitUiHide(),
    );
  ...
  logAboutViewImpression = () => {
    const event = this.carSettingsCarthingosEventFactory.aboutRowFactory().aboutViewFactory().impression();
    this.ubiLogger.logImpression(event);
  };
  ...
  logRestartSubmenuViewImpression = () => {
    const event = this.carSettingsCarthingosEventFactory.restartRowFactory().restartSubmenuViewFactory().impression();
    this.ubiLogger.logImpression(event);
  };
  ...
  logPowerOffOnRowDialPressed = () => {
    const event = this.carSettingsCarthingosEventFactory.restartRowFactory().powerOffOnRowFactory().keyStrokeUiReveal();
    this.ubiLogger.logInteraction(event);
  };

  logPowerOffOnRowClick = () => {
    const event = this.carSettingsCarthingosEventFactory.restartRowFactory().powerOffOnRowFactory().hitUiReveal();
    this.ubiLogger.logInteraction(event);
  };
