import { IconPlaybackSpeed1point5x } from '@spotify-internal.old/encore-web';
...
const CarThingIconPlaybackSpeed1point5x = ({ className, iconSize }: Props) => (
  <IconPlaybackSpeed1point5x iconSize={iconSize as IconSize} className={className} width={iconSize} height={iconSize} />
);
