import { IconPlaybackSpeed1x } from '@spotify-internal.old/encore-web';
...
const CarThingIconPlaybackSpeed1x = ({ className, iconSize }: Props) => (
  <IconPlaybackSpeed1x iconSize={iconSize as IconSize} className={className} width={iconSize} height={iconSize} />
);
