...
const VOICE_CONFIRMATION_INTENTS_WITHOUT_ICON = [PLAY_INTENT, STOP_INTENT, NEXT_INTENT, PREVIOUS_INTENT];
...
export const SEARCH_RESULT_INTENTS = [SHOW_INTENT, SEARCH_INTENT, NO_INTENT, PLAY_INTENT, MORE_LIKE_THIS];
