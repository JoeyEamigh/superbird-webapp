...
const Tracklist = () => {
  ...
  const loadingState = <div className={styles.emptyBody} data-testid="loading" />;
  ...
  return (
    <>
      <AmbientBackdrop imageId={uiState.currentPlayingImageId} getBackgroundStyleAttribute={getGradientBackground} />
      <div
      ...
      >
        ...
        {showEmptyState && <EmptyTracklistState contextUri={uiState.contextUri} />}
