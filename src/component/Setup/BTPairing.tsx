...
const BTPairing = () => {
  ...
  return (
    <div className={styles.screen} data-testid={`${SetupView.BT_PAIRING}-screen`}>
      <div className={styles.title}>Pairing code</div>
      <div className={styles.content}>
        <div className={styles.texts}>In the Spotify app, confirm that you see the code below.</div>
