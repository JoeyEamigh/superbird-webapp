...
const StartSetup = () => {
  ...
  return (
    <div className={styles.screen} data-testid={`${SetupView.START_SETUP}-screen`}>
      <div className={styles.title}>Start setup</div>
      <div className={styles.content}>
        <div className={styles.texts}>
          <div className={styles.subtitle}>
            Point your phone’s camera at this QR code and tap the link that appears.
          </div>
          <div className={styles.needHelp} data-testid="go-to-help" onClick={() => setShowHelp(true)}>
            Need some help?
          </div>
        </div>
