    ...
    <div className={styles.screen} data-testid={`${SetupView.HELP}-screen`}>
      <div className={styles.content}>
        <div className={styles.texts}>
          <div className={styles.subtitle}>Here’s another way to start setup:</div>
          <div className={styles.subtitle}>
            <ul className={styles.subtitle}>
              <li>
                Open the <span className={styles.white}>Spotify</span> app on your phone
              </li>
              <li>
        ...
        <div className={styles.backToSetup} data-testid="go-to-start-setup" onClick={() => onBackToStart()}>
          Back to Start setup
        </div>
      </div>
    </div>
