...
const PlayingInfo = () => {
  ...
  return (
    <div className={styles.playingInfo} {...swipeHandlers} data-testid="npv-playing-info">
      <Artwork tracks={tracks} getAnimationClassNames={getAnimationClassNames} />
      <div className={styles.info}>
        <div className={styles.playingInfoHeader}>
          <PlayingInfoHeader />
          <StatusIcons />
        </div>
        <PlayingInfoTitles tracks={tracks} getAnimationClassNames={getAnimationClassNames} />
      </div>
    </div>
  );
};
