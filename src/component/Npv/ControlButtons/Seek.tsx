import { IconSeek15Back48, IconSeek15Foward48 } from 'component/CarthingUIComponents';
  ...
  return (
    <>
      {direction === SkipDirection.BACK ? (
        <ControlButton id={NpvIcon.SEEK_BACK_15} onClick={uiState.handleSeekBackClick} isDisabled={!uiState.canSeek}>
          <IconSeek15Back48 />
        </ControlButton>
      ) : (
        <ControlButton
