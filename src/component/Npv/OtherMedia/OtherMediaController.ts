...
export type OtherMediaController = ReturnType<typeof createOtherMediaController>;
...
export const createOtherMediaController = (
  ...
  return {
    ...
    handleArtworkClick() {
      ubiLogger.otherMediaUbiLogger.logArtworkClicked(playerStore.playing, playerStore.currentTrackUri);
