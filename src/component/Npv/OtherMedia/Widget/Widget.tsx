    ...
    <div className={styles.otherMediaWidget}>
      ...
      {uiState.shouldShowContent && (
        <div className={styles.metadata}>
          ...
          <Type name="brioBold" className={classNames(styles.title, styles.truncate)}>{`${uiState.title}`}</Type>
          <Type name="celloBook" className={classNames(styles.subtitle, styles.truncate)}>{`${uiState.subtitle}`}</Type>
        </div>
      )}
    </div>
  );
