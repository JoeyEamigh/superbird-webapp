...
import { Button, ButtonType, IconPhoneAnswer } from 'component/CarthingUIComponents';
...
const AnswerButton = () => {
  ...
  return (
    <Button
      ...
      onClick={() => (uiState.shouldShowAnswerOrDeclineButtons ? uiState.answer() : uiState.hangUp())}
