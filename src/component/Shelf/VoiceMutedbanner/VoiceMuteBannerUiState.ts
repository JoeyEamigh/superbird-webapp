...
export type VoiceMuteBannerUiState = ReturnType<typeof createVoiceMuteBannerUiState>;

const createVoiceMuteBannerUiState = (voiceStore: VoiceStore, contentShelfUbiLogger: ContentShelfUbiLogger) => {
