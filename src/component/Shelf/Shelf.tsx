...
const getGradientBackground = (rgbChannels: number[]): string => {
  return `radial-gradient(ellipse at 100px -200px, rgb(${rgbChannels.join(',')}) 5%, black 60%)`;
};
...
const Shelf = () => {
  ...
  return (
    <>
      <AmbientBackdrop imageId={playerStore.currentImageId} getBackgroundStyleAttribute={getGradientBackground} />
