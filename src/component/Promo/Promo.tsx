...
const PROMOS: Record<PromoType, PromoContent> = {
  other_media: {
    ...
    buttonText: 'Got it',
    image: '/images/other-media.83237a6ee7e62a4fb53b.png',
  },
  phone_calls: {
    title: 'Phone Calls',
    buttonText: 'Got it',
...
const PromoWrapper = () => {
  ...
  return (
    <Promo
      promo={promoCache}
      onClickButton={() => promoController.handlePromoConfirmationSelected(promoCache)}
      onClickOption={() => promoController.handlePromoOptionSelected(promoCache)}
    />
  );
};
