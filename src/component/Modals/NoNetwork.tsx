...
import { Button, ButtonType, IconPublic, Type } from 'component/CarthingUIComponents';
  ...
  <div className={styles.noNetworkWrapper} data-testid="no_network-modal-type">
    <div className={styles.noNetwork}>
      <div className={styles.noNetworkContent}>
        ...
        <Type name="celloBook">
          Make sure cellular data is turned on in your phone’s Settings. We’ll let you know when you’re back online.
        </Type>
      </div>
