...
const LetsDrive = () => {
  ...
  useEffect(() => ubiLogger.modalUbiLogger.logLetsDriveImpression(), [ubiLogger.modalUbiLogger]);
  return (
    <LegacyModal>
      <div className={classNames(styles.modalRoot, styles.errorModal)} data-testid="lets_drive-modal-type">
        <IconNowPlaying className={classNames(styles.modalIcon, styles.iconNowPlaying)} />
        ...
        <div className={styles.modalText} data-testid="modal-text">
          ...
          or try
          <br />
          <span className={styles.boldText}> &quot;Hey Spotify, play some music&quot; </span>
          to get things going.
        </div>
      </div>
    </LegacyModal>
