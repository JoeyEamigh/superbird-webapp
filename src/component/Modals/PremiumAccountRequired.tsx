...
const PremiumAccountRequired = () => {
  ...
  useEffect(() => ubiLogger.modalUbiLogger.logNeedPremiumModalShown(), [ubiLogger.modalUbiLogger]);
  return (
    <div data-testid="premiumneeded-modal-type" className={styles.dialog}>
      ...
      <div className={styles.description}>
        <p>To use Car Thing you need to be logged in to a Spotify Premium or Premium Family account on your phone.</p>
      </div>
    </div>
  );
};
