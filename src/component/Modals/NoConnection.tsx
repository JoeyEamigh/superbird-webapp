...
const NoConnection = () => {
  ...
  useEffect(() => ubiLogger.modalUbiLogger.logNoConnectionModalImpression(), [ubiLogger.modalUbiLogger]);
  ...
  return (
    <div data-testid="no_connection-modal-type" className={styles.dialog}>
      ...
      <div className={styles.description}>
        <p>Car Thing will automatically try to reconnect. You can also tap below and choose a phone to reconnect to.</p>
      </div>
