...
class OnboardingUbiLogger {
  ...
  constructor(ubiLogger: UbiLogger) {
    ...
    this.carOnboardingStartCarthingosEventFactory = createCarOnboardingStartCarthingosEventFactory();
    this.carOnboardingLearnVoiceCarthingosEventFactory = createCarOnboardingLearnVoiceCarthingosEventFactory();
    this.carOnboardingLearnTactileCarthingosEventFactory = createCarOnboardingLearnTactileCarthingosEventFactory();
  }
  ...
  logFirstUpShown = () => {
    const event = this.carOnboardingLearnVoiceCarthingosEventFactory.firstUpContainerFactory().impression();
    this.ubiLogger.logImpression(event);
  };

  logTryPlayPlaylistShown = () => {
    const event = this.carOnboardingLearnVoiceCarthingosEventFactory.tryPlayingPlaylistContainerFactory().impression();
    this.ubiLogger.logImpression(event);
  };

  logTrySkipNextShown = () => {
    const event = this.carOnboardingLearnVoiceCarthingosEventFactory.trySkipNextContainerFactory().impression();
    this.ubiLogger.logImpression(event);
  };
  ...
  logLastStepShown = () => {
    const event = this.carOnboardingLearnTactileCarthingosEventFactory.lastStepContainerFactory().impression();
    this.ubiLogger.logImpression(event);
  };
  ...
  logNoInteractionEndButtonDialPress = (reason: string, destination: string) => {
    const event = this.carOnboardingLearnTactileCarthingosEventFactory
      .noInteractionContainerFactory({ reason })
      .endButtonFactory()
