...
const LearnTactile = () => {
  ...
  useEffect(() => {
    ...
    const effect = async () => {
      ...
      await onboardingStore.waitForTts(learnTactileTTS[LearnTactileTtsNames.SHELF_EXPLAIN]);
      if (mounted) {
        ...
        await onboardingStore.waitForTts(learnTactileTTS[LearnTactileTtsNames.SHELF_DIAL_TURN]);
      }
    };
    runInAction(effect);
    ...
    const effect = async () => {
      switch (onboardingStore.dialTurnCounter) {
        ...
        case 2:
          ...
          onboardingStore.waitForTts(learnTactileTTS[LearnTactileTtsNames.SHELF_DIAL_PRESS]);
          break;
        default:
          break;
      }
        ...
        case 1:
          ...
          runInAction(() => {
            if (onboardingStore.isOnboardingOngoing) {
              onboardingStore.setDialTurnEnabled(true);
              startNoInteractionTimer(LearnTactileTtsNames.TRACKLIST_DIAL_PRESS);
              onboardingUbiLogger.logTrackListDialPressShown();
              onboardingStore.waitForTts(learnTactileTTS[LearnTactileTtsNames.TRACKLIST_DIAL_PRESS]);
            }
          });
          break;
        case 2:
          ...
          await onboardingStore.waitForTts(learnTactileTTS[LearnTactileTtsNames.NPV_EXPLAIN]);
          setShowDialPressPulse(true);
          onboardingStore.setDialPressEnabled(true);
          ...
          onboardingStore.waitForTts(learnTactileTTS[LearnTactileTtsNames.NPV_DIAL_PRESS]);
          break;
        case 3:
          window.clearTimeout(noInteractionTimeoutId.current);
          setShowDialPressPulse(false);
          ...
          onboardingStore.waitForTts(learnTactileTTS[LearnTactileTtsNames.NPV_BACK_PRESS]);
          break;
        default:
          break;
      }
    ...
    const effect = async () => {
      switch (onboardingStore.backCounter) {
        case 1:
          ...
          await onboardingStore.waitForTts(learnTactileTTS[LearnTactileTtsNames.TRACKLIST_BACK_PRESS]);
          break;
        case 2:
          window.clearTimeout(noInteractionTimeoutId.current);
          ...
          await onboardingStore.waitForTts(learnTactileTTS[LearnTactileTtsNames.SHELF_BACK_PRESS]);
          break;
        case 3:
          window.clearTimeout(noInteractionTimeoutId.current);
          ...
          onboardingStore.setDialTurnEnabled(true);
          onboardingStore.setDialPressEnabled(true);
          await onboardingStore.waitForTts(learnTactileTTS[LearnTactileTtsNames.END_TOUR]);
          runInAction(() => {
            if (!playerStore.playing) {
              playerStore.play();
            }
  ...
  return (
    <div className={styles.learnTactile} data-testid="onboarding-learn-tactile">
      ...
      {!onboardingStore.noInteractionModal && <div className={styles.blockTouch} />}
      <Overlay show={!!onboardingStore.noInteractionModal} appear={FROM.FADE_IN}>
        <NoInteractionModal />
      </Overlay>
    </div>
  );
