...
const Views = () => {
  ...
  const tracklistOverNpv = viewStore.currentView === View.TRACKLIST && viewStore.viewUnderCurrentView === View.NPV;

  const queueOverNpv = viewStore.currentView === View.QUEUE && viewStore.viewUnderCurrentView === View.NPV;
      ...
      {[
        ...
        <div
          ...
          className={classNames(styles.view, {
            ...
            [styles.forceOnTop]:
              (tracklistOverNpv && view.name === View.TRACKLIST) || (queueOverNpv && view.name === View.QUEUE),
          })}
        >
          <DelayedRender showing={view.name === viewStore.currentView} hideDelay={transitionDurationMs}>
            {view.component}
          </DelayedRender>
        </div>
      ))}
