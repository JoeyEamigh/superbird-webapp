    ...
    <div data-testid="dev-options" className={styles.devOptions}>
      ...
      <div className={styles.options}>
        ...
        <label htmlFor="alert-threshold" className={styles.devOptionsCounting}>
          ...
          <section>
            <ButtonSecondary buttonSize="sm" onClick={action(() => devOptionsStore.handleCountWindThreshold(1))}>
              +
            </ButtonSecondary>
            <ButtonSecondary buttonSize="sm" onClick={action(() => devOptionsStore.handleCountWindThreshold(-1))}>
              -
        ...
        <label htmlFor="cache-size" className={styles.devOptionsCounting}>
          ...
          <section id="cache-size">
            <ButtonSecondary buttonSize="sm" onClick={action(() => devOptionsStore.setImageStoreCacheSize(25))}>
              +
            </ButtonSecondary>
            <ButtonSecondary buttonSize="sm" onClick={action(() => devOptionsStore.setImageStoreCacheSize(-25))}>
              -
        ...
        <ButtonPrimary className={styles.requestTipBtn} onClick={devOptionsStore.getNewTip}>
          Request new tip
        </ButtonPrimary>
        <ButtonPrimary className={styles.requestTipBtn} onClick={devOptionsStore.clearLocalStorage}>
          Clear localStorage
        </ButtonPrimary>
      </div>
