...
import { learnTactileTTS, LearnTactileTtsNames } from 'component/Onboarding/tts/Tactile';
...
class OnboardingStore {
  ...
  constructor(
    ...
    socket.addSocketEventListener((msg: SettingsMessage) => this.onMiddlewareEvent(msg));
  }
  ...
  onMiddlewareEvent(msg: SettingsMessage) {
    if (msg.type === 'settings_response' && msg.payload.key === 'onboarding_status') {
  ...
  get shouldShowOnboarding(): boolean {
    return !this.onboardingFinished || (this.onboardingFinished && this.onboardingStarted);
  }
  ...
  hideNoInteractionModal() {
    if (this.noInteractionModal) {
      ...
      this.setDialPressEnabled(this.noInteractionModal.tactileEnabledOnClose.press);
      this.setDialTurnEnabled(this.noInteractionModal.tactileEnabledOnClose.turn);
  ...
  handleDialTurn() {
    if (this.noInteractionModal) {
      this.noInteractionModal.currentOption =
        this.noInteractionModal.currentOption === NoInteractionModalOption.CONTINUE
  ...
  handleStartClick = () => {
    this.rootStore.ubiLogger.onboardingUbiLogger.logStartClicked(OnboardingStepId[OnboardingStepId.LEARN_VOICE]);
