...
import { createOtherMediaController, OtherMediaController } from 'component/Npv/OtherMedia/OtherMediaController';
import MiddlewareActions from 'middleware/MiddlewareActions';
import { createNpvController, NpvController } from 'component/Npv/NpvController';
...
class NpvStore {
  ...
  constructor(rootStore: RootStore, middlewareActions: MiddlewareActions) {
    ...
    this.swipeHandler = new SwipeHandler(rootStore.playerStore, rootStore.timerStore, rootStore.ubiLogger.npvUbiLogger);
