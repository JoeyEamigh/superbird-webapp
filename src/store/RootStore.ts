...
import { createOverlayController, OverlayController } from 'component/Overlays/OverlayController';
...
export class RootStore {
  ...
  constructor(
    ...
    this.remoteConfigStore = new RemoteConfigStore(this, socket, middlewareActions);
    this.hardwareStore = new HardwareStore(socket, middlewareActions);
    this.ubiLogger = new UbiLogger(interappActions, this.remoteConfigStore, this.hardwareStore);
    ...
    this.onboardingStore = new OnboardingStore(this, socket, interappActions, middlewareActions);
    ...
    this.airVentInterferenceController = new AirVentInterferenceController(this);
    ...
    this.podcastSpeedStore = new PodcastSpeedStore(this, interappActions, socket);
    this.phoneCallController = new PhoneCallController(this, socket, middlewareActions);
    this.savedStore = new SavedStore(this.playerStore, interappActions, errorHandler);
    this.permissionsStore = new PermissionsStore(this.overlayController, socket, interappActions, errorHandler);
    ...
    this.phoneConnectionStore = new PhoneConnectionStore(this, middlewareActions);

    this.radioStore = new RadioStore(this);
    this.podcastStore = new PodcastStore(interappActions, this.remoteConfigStore, errorHandler);
