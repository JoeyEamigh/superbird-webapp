...
type BluetoothMessage = ConnectionStatus | CurrentDevice | LocalDevice | PairingFinished | Pin | DeviceList;
  ...
  onEvent(msg: BluetoothMessage) {
    switch (msg.type) {
      ...
      case 'bluetooth_pairing_finished':
        this.onPairingFinishedCallbacks.forEach(callback => callback(msg.success || false));
        this.pairing = false;
