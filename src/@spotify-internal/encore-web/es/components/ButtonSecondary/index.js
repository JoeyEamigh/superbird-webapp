...
import { buttonSizesWithDeprecationWarning } from '../../styles';
...
var ButtonComponent = /*#__PURE__*/ React.forwardRef(function ButtonComponent(_ref, ref) {
  ...
  if (iconOnly && !ariaLabel && !ariaLabelledby) {
    warn(
      'ButtonSecondary must have an aria-label or aria-labelledby attribute defined when using the iconOnly prop in order to be accessible.',
    );
  }
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    Object.assign({}, props, {
      ...
      status: status,
      'data-encore-id': ENCORE_DATA_IDS.ButtonSecondary,
    }),
 ...
 */
var buttonHelpers = _objectSpread(
  _objectSpread({}, buttonSizesWithDeprecationWarning),
  {},
  {
 ...
 *
 * [GitHub](https://ghe.spotify.net/encore/web/tree/master/src/core/components/ButtonSecondary) | [Figma](https://www.figma.com/file/bnQXqGkLeiTlbk8JXGDcsX/Encore-Web---Light-Theme-Toolkit?node-id=20339:12185)
 *
 * Secondary buttons have a stroke and no fill and indicate an alternate or less important action.
 *
 * [Read the full component documentation →](https://encore.spotify.net/web/components/button?format=figma-figma#buttonsecondary)
 *
 * @example
