 ...
 *
 * [GitHub](https://ghe.spotify.net/encore/web/tree/master/src/core/components/LogoSpotify) | [Figma](https://www.figma.com/file/bnQXqGkLeiTlbk8JXGDcsX/Encore-Web---Light-Theme-Toolkit?node-id=391:1229)
 *
 * Renders the full logo for the Spotify masterbrand
 *
 * [Read the full component documentation →](https://encore.spotify.net/web/components/logo?format=figma-figma#main-logos)
 *
 * @example
...
export var LogoSpotify = function LogoSpotify(_ref) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    Object.assign(
      ...
      props,
      {
        'data-encore-id': ENCORE_DATA_IDS.LogoSpotify,
      },
    ),
