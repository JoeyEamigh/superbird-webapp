...
export var Button = styled(
  /*#__PURE__*/ React.forwardRef(function Button(_ref, ref) {
  ...
  var disabledStyles = css(
    ...
    fallbackSet.background.base,
    fallbackSet.text.base,
    ButtonFocus,
  );
  var activeStyles = css(
    ...
    ButtonInner,
    fallbackSet.background.press,
    ButtonFocus,
  );
  var hoverStyles = css(
    ['', ' ', '{background-color:var(--background-highlight,', ');}'],
    !fullWidth && css(['', ',', '{', '}'], ButtonInner, ButtonFocus, buttonStylesHover),
    ButtonInner,
    fallbackSet.background.highlight,
  );
  ...
  return css(
    ...
    hoverStyles,
    hover && css(['&&{', '}'], hoverStyles),
    activeStyles,
    active && css(['&&{', '}'], activeStyles),
    focusStyles,
    focus && css(['&&{', '}'], focusStyles),
    disabledStyles,
  );
});
