...
export function IconSearchActive(props) {
  ...
  var iconList = [{
    'size': 16,
    'svgContent': '<path d=\'M7 1.75a5.25 5.25 0 1 0 0 10.5 5.25 5.25 0 0 0 0-10.5zM.25 7a6.75 6.75 0 1 1 12.096 4.12l3.184 3.185a.75.75 0 1 1-1.06 1.06L11.304 12.2A6.75 6.75 0 0 1 .25 7z\'/><path d=\'M10.75 7a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0z\'/>'
  }, {
    'size': 24,
