...
export function IconChevronRight(props) {
  ...
  var iconList = [{
    'size': 16,
    'svgContent': '<path d=\'M4.97.47a.75.75 0 0 0 0 1.06L11.44 8l-6.47 6.47a.75.75 0 1 0 1.06 1.06L13.56 8 6.03.47a.75.75 0 0 0-1.06 0z\'/>'
  }, {
    'size': 24,
    'svgContent': '<path d=\'M8.043 2.793a1 1 0 0 0 0 1.414L15.836 12l-7.793 7.793a1 1 0 1 0 1.414 1.414L18.664 12 9.457 2.793a1 1 0 0 0-1.414 0z\'/>'
  }];
