...
export function IconBlock(props) {
  ...
  var iconList = [{
    'size': 16,
    'svgContent': '<path d=\'M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z\'/><path d=\'M12 8.75H4v-1.5h8v1.5z\'/>'
  }, {
    'size': 24,
    'svgContent': '<path d=\'M16.999 11h-10v2h10v-2z\'/><path d=\'M11.999 1c-6.075 0-11 4.925-11 11s4.925 11 11 11 11-4.925 11-11-4.925-11-11-11zm-9 11a9 9 0 1 1 18 0 9 9 0 0 1-18 0z\'/>'
  }];
