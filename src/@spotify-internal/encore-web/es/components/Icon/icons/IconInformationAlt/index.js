...
export function IconInformationAlt(props) {
  ...
  var iconList = [{
    'size': 16,
    'svgContent': '<path d=\'M8 14.5a6.5 6.5 0 1 1 0-13 6.5 6.5 0 0 1 0 13zM0 8a8 8 0 1 0 16 0A8 8 0 0 0 0 8z\'/><path d=\'M7.25 7v5h1.5V7h-1.5zm0-3.026v1.5h1.5v-1.5h-1.5z\'/>'
  }, {
    'size': 24,
    'svgContent': '<path d=\'M11 6v2h2V6h-2zm0 4v8h2v-8h-2z\'/><path d=\'M12 21a9 9 0 1 1 0-18 9 9 0 0 1 0 18zM1 12c0 6.075 4.925 11 11 11s11-4.925 11-11S18.075 1 12 1 1 5.925 1 12z\'/>'
  }];
