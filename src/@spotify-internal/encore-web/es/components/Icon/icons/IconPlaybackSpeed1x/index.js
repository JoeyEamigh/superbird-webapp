...
export function IconPlaybackSpeed1x(props) {
  ...
  var iconList = [{
    'size': 16,
    'svgContent': '<path d=\'M4.485 2.37c0 .734-.759 1.533-1.957 1.533h-.417v1.5h2.374v7.992h1.5V2.37h-1.5zm9.935 6.043-1.97 1.97 1.97 1.97-1.061 1.06-1.97-1.97-1.97 1.97-1.06-1.06 1.97-1.97-1.97-1.97 1.06-1.06 1.97 1.969 1.97-1.97 1.06 1.061z\'/>'
  }, {
    'size': 24,
    'svgContent': '<path d=\'M7.578 4c0 1.146-1.174 2.345-2.967 2.345H4v2h3.578v11.809h2V4h-2zm13.072 9.755-2.542 2.543 2.543 2.543-1.415 1.414-2.543-2.543-2.543 2.543-1.414-1.414 2.543-2.543-2.543-2.543 1.414-1.414 2.543 2.543 2.543-2.543 1.415 1.414z\'/>'
  }];
