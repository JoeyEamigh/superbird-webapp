...
export function IconMic(props) {
  ...
  var iconList = [{
    'size': 16,
    'svgContent': '<path d=\'M4 4a4 4 0 1 1 8 0v3a4 4 0 0 1-8 0V4zm4-2.5A2.5 2.5 0 0 0 5.5 4v3a2.5 2.5 0 0 0 5 0V4A2.5 2.5 0 0 0 8 1.5z\'/><path d=\'M2.25 6v1a5.75 5.75 0 0 0 11.5 0V6h1.5v1a7.251 7.251 0 0 1-6.5 7.212V16h-1.5v-1.788A7.251 7.251 0 0 1 .75 7V6h1.5z\'/>'
  }, {
    'size': 24,
    'svgContent': '<path d=\'M7 5a5 5 0 0 1 10 0v6a5 5 0 0 1-10 0V5zm5-3a3 3 0 0 0-3 3v6a3 3 0 1 0 6 0V5a3 3 0 0 0-3-3z\'/><path d=\'M3 7a1 1 0 0 1 1 1v3a8 8 0 1 0 16 0V8a1 1 0 1 1 2 0v3c0 5.185-3.947 9.449-9 9.95V24h-2v-3.05c-5.053-.5-9-4.764-9-9.95V8a1 1 0 0 1 1-1z\'/>'
  }];
