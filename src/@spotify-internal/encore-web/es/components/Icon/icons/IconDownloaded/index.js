...
export function IconDownloaded(props) {
  ...
  var iconList = [{
    'size': 16,
    'svgContent': '<path d=\'M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-4.75a.75.75 0 0 0-.75.75v5.94L6.055 8.744a.75.75 0 1 0-1.06 1.06L8 12.811l3.005-3.006a.75.75 0 1 0-1.06-1.06L8.75 9.939V4A.75.75 0 0 0 8 3.25z\'/>'
  }, {
    'size': 24,
    'svgContent': '<path d=\'M1 12C1 5.925 5.925 1 12 1s11 4.925 11 11-4.925 11-11 11S1 18.075 1 12zm12-4.95a1 1 0 0 0-2 0v7.486l-1.793-1.793a1 1 0 0 0-1.414 1.414L12 18.364l4.207-4.207a1 1 0 0 0-1.414-1.415L13 14.535V7.05z\'/>'
  }];
