...
export function IconExclamationCircle(props) {
  ...
  var iconList = [{
    'size': 16,
    'svgContent': '<path d=\'M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z\'/><path d=\'M7.25 9V4h1.5v5h-1.5zm0 3.026v-1.5h1.5v1.5h-1.5z\'/>'
  }, {
    'size': 24,
    'svgContent': '<path d=\'M11 18v-2h2v2h-2zm0-4V6h2v8h-2z\'/><path d=\'M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18zM1 12C1 5.925 5.925 1 12 1s11 4.925 11 11-4.925 11-11 11S1 18.075 1 12z\'/>'
  }];
