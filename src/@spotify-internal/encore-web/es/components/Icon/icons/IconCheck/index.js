...
export function IconCheck(props) {
  ...
  var iconList = [{
    'size': 16,
    'svgContent': '<path d=\'M15.53 2.47a.75.75 0 0 1 0 1.06L4.907 14.153.47 9.716a.75.75 0 0 1 1.06-1.06l3.377 3.376L14.47 2.47a.75.75 0 0 1 1.06 0z\'/>'
  }, {
    'size': 24,
    'svgContent': '<path d=\'M21.707 4.805a1 1 0 0 1 0 1.414L8.024 19.902l-5.731-5.73a1 1 0 1 1 1.414-1.415l4.317 4.317L20.293 4.805a1 1 0 0 1 1.414 0z\'/>'
  }];
