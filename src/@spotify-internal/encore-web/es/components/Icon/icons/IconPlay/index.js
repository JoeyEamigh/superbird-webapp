...
export function IconPlay(props) {
  ...
  var iconList = [{
    'size': 16,
    'svgContent': '<path d=\'M3 1.713a.7.7 0 0 1 1.05-.607l10.89 6.288a.7.7 0 0 1 0 1.212L4.05 14.894A.7.7 0 0 1 3 14.288V1.713z\'/>'
  }, {
    'size': 24,
    'svgContent': '<path d=\'m7.05 3.606 13.49 7.788a.7.7 0 0 1 0 1.212L7.05 20.394A.7.7 0 0 1 6 19.788V4.212a.7.7 0 0 1 1.05-.606z\'/>'
  }];
