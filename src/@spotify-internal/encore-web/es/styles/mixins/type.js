...
var responsiveVariant = function responsiveVariant(mobileToken, desktopToken) {
  ...
  var isDesktopDifferent =
    isSizeDifferent || isWeightDifferent || isFamilyDifferent || isTransformDifferent || isLetterSpacingDifferent;
  return css(
    [
      'font-size:',
      ';font-weight:',
    ...
    mobileToken.fontSize,
    mobileToken.fontWeight,
    mobileToken.textTransform,
    mobileToken.letterSpacing,
    mobileToken.fontFamily /* only apply desktop styles if they differ from mobile ones */,
    isDesktopDifferent &&
      css(
        [
          '@media (min-width:',
        ...
        isSizeDifferent && desktopToken.fontSize,
        isWeightDifferent && desktopToken.fontWeight,
        isFamilyDifferent && 'var(--font-family, '.concat(desktopToken.fontFamily, ')'),
        isTransformDifferent && desktopToken.textTransform,
        isLetterSpacingDifferent && desktopToken.letterSpacing,
      ),
  );
};
