...
import { controlPaddingBlock } from '../';
...
export var formControlBase = function formControlBase(useBrowserDefaultFocusStyle) {
  return css(
    [
      '-webkit-appearance:none;background-image:none;border:0;display:block;',
      ';transition:box-shadow ease-in-out 0.1s,color ease-in-out 0.1s;inline-size:100%;&::placeholder{opacity:1;}',
      ' &:disabled{cursor:not-allowed;opacity:1;}',
    ],
    ballad(),
    !useBrowserDefaultFocusStyle && css(['&:focus,&:hover:focus{outline:0;}']),
  );
};
...
export var formControlBaseSelect = function formControlBaseSelect() {
  return css(
    [
      '',
      ";margin-block-start:0;margin-block-end:0;appearance:none;box-shadow:none;text-indent:0.01px;text-overflow:'';&::-ms-expand{display:none;}border-radius:",
      ';padding-block-start:',
      ';padding-block-end:',
      ';padding-inline-start:14px;padding-inline-end:44px;',
    ],
    rootStyle(),
    spacer4,
    controlPaddingBlock.md,
    controlPaddingBlock.md,
  );
};
...
export var formChevronDown = function formChevronDown() {
  return css(
    ['color:', ";pointer-events:none;position:absolute;right:14px;[dir='rtl'] &{left:14px;right:auto;}"],
...
export var formCheck = function formCheck() {
  return css(
    [
      '',
      ';align-items:center;display:flex;padding-block-end:',
      ';padding-block-start:',
      ';position:relative;min-block-size:',
      ';',
    ],
    rootStyle(),
    spacer4,
...
export var formCheckIndicator = function formCheckIndicator(radius) {
  return css(
    [
      ...
      ';display:inline-block;block-size:',
      ';position:relative;user-select:none;inline-size:',
      ';flex-shrink:0;align-self:flex-start;top:0;',
    ],
    rootStyle(),
    radius,
    spacer16,
...
export var formControlTheme = function formControlTheme(_ref) {
  ...
  var focusStyles = css(
    ...
    isUsingKeyboard ? 3 : 1.5,
    cssColorValue(semanticColors.essentialBase),
  );
  var errorStyles = css(
    ['&,&:hover{box-shadow:inset 0 0 0 1px ', ';}&:focus{box-shadow:inset 0 0 0 ', 'px ', ';}'],
  ...
  return css(
    [
      ...
      ';}&:disabled{opacity:',
      ';box-shadow:inset 0 0 0 1px ',
      ';}&[readonly]{box-shadow:inset 0 0 0 1px ',
      ';}&:invalid{',
      ';}',
      '',
    ],
    ...
    hoverStyles,
    isHover && hoverStyles,
    !useBrowserDefaultFocusStyle && focusStyles,
    isFocus && !useBrowserDefaultFocusStyle && focusStyles,
    cssColorValue(semanticColors.textSubdued),
    opacityDisabled,
    cssColorValue(semanticColors.essentialSubdued),
    cssColorValue(semanticColors.decorativeSubdued),
