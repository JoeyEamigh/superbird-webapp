...
export class PageViewLogger {
  ...
  constructor(options: PageTransitionLoggerOptions) {
    ...
    this.disableAutoBackgroundMonitoring = options.disableAutoBackgroundMonitoring;
  ...
  completeNavigation(navigationInfo: NavigationEndInfo): void {
    ...
    if (this.currentEntityUri !== entityUri && this.navigationStatus === NavigationEvents.NAVIGATION_STARTED) {
