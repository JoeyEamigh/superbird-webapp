...
export function createURI<T extends URIType, P extends URIProps>(type: T, props: P): URIExtended<T, P> {
...
export function parseURI<T extends { type: URIType }>(maybeURI?: T): Extract<TypedURI, { type: T['type'] }> | null;
