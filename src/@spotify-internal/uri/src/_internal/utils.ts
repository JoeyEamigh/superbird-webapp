...
export function getComponents(uri: TypedURI, format: URIFormat): Component[] {
  ...
  switch (uri.type) {
    ...
    case URITypeMap.FOLDER:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.FOLDER, uri.id];
    case URITypeMap.FOLLOWERS:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.FOLLOWERS];
    case URITypeMap.FOLLOWING:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.FOLLOWING];
    case URITypeMap.PLAYLIST:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.PLAYLIST, uri.id];
    case URITypeMap.PLAYLIST_V2:
      return [URITypeMap.PLAYLIST, uri.id];
    case URITypeMap.STARRED:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.STARRED];
    ...
    case URITypeMap.USER_TOPLIST:
      return [URIParticle.USER, encodeComponent(uri.username, format), URIParticle.TOP, uri.toplist];
    // Legacy Toplist
    case URITypeMap.USER_TOP_TRACKS:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.TOPLIST];
    case URITypeMap.TOPLIST:
      return [URIParticle.TOP, uri.toplist].concat(
        uri.global || !uri.country ? [URIParticle.GLOBAL] : ['country', uri.country],
      );
    case URITypeMap.INBOX:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.INBOX];
    case URITypeMap.ROOTLIST:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.ROOTLIST];
    case URITypeMap.PUBLISHED_ROOTLIST:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.PUBLISHED_ROOTLIST];
    case URITypeMap.COLLECTION_TRACK_LIST:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.COLLECTION_TRACK_LIST, uri.id];
    ...
    case URITypeMap.LOCAL_ALBUM:
      return [URITypeMap.LOCAL_TRACK, encodeComponent(uri.artist, format), encodeComponent(uri.album, format)];
    ...
    case URITypeMap.LIBRARY:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.LIBRARY].concat(
        uri.category ? [uri.category] : [],
      );
    ...
    case URITypeMap.RADIO:
      ...
      args = uri.args || [];
      for (i = 0, len = args.length; i < len; ++i) components.push(encodeComponent(args[i], format));
      return components;
    ...
    case URITypeMap.COLLECTION_ALBUM:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.COLLECTION, URITypeMap.ALBUM, uri.id];
    ...
    case URITypeMap.COLLECTION:
      return [URIParticle.USER, encodeComponent(uri.username, format), URITypeMap.COLLECTION].concat(
        uri.category ? [uri.category] : [],
      );
