...
export function base62ToHex(s: string): string | null {
  ...
  p0 -= p1 * MAX_INT;
  // 62^10 < 2^64
  v = _ID62[s.charCodeAt(7)] * 3844 + _ID62[s.charCodeAt(8)] * 62 + _ID62[s.charCodeAt(9)];
  // eslint-disable no-unused-expressions
  (p0 = p0 * P62_3 + v), (p0 = p0 - (v = (p0 * MAX_INT_INV) | 0) * MAX_INT);
  p1 = p1 * P62_3 + v;
  // 62^13 < 2^96
  v = _ID62[s.charCodeAt(10)] * 3844 + _ID62[s.charCodeAt(11)] * 62 + _ID62[s.charCodeAt(12)];
  (p0 = p0 * P62_3 + v), (p0 = p0 - (v = (p0 * MAX_INT_INV) | 0) * MAX_INT);
  (p1 = p1 * P62_3 + v), (p1 = p1 - (v = (p1 * MAX_INT_INV) | 0) * MAX_INT);
  p2 = v;
  // 62^16 < 2^96
  v = _ID62[s.charCodeAt(13)] * 3844 + _ID62[s.charCodeAt(14)] * 62 + _ID62[s.charCodeAt(15)];
  (p0 = p0 * P62_3 + v), (p0 = p0 - (v = (p0 * MAX_INT_INV) | 0) * MAX_INT);
  (p1 = p1 * P62_3 + v), (p1 = p1 - (v = (p1 * MAX_INT_INV) | 0) * MAX_INT);
  p2 = p2 * P62_3 + v;
  // 62^19 < 2^128
  v = _ID62[s.charCodeAt(16)] * 3844 + _ID62[s.charCodeAt(17)] * 62 + _ID62[s.charCodeAt(18)];
  (p0 = p0 * P62_3 + v), (p0 = p0 - (v = (p0 * MAX_INT_INV) | 0) * MAX_INT);
  (p1 = p1 * P62_3 + v), (p1 = p1 - (v = (p1 * MAX_INT_INV) | 0) * MAX_INT);
  (p2 = p2 * P62_3 + v), (p2 = p2 - (v = (p2 * MAX_INT_INV) | 0) * MAX_INT);
  p3 = v;
  v = _ID62[s.charCodeAt(19)] * 3844 + _ID62[s.charCodeAt(20)] * 62 + _ID62[s.charCodeAt(21)];
  (p0 = p0 * P62_3 + v), (p0 = p0 - (v = (p0 * MAX_INT_INV) | 0) * MAX_INT);
  (p1 = p1 * P62_3 + v), (p1 = p1 - (v = (p1 * MAX_INT_INV) | 0) * MAX_INT);
  (p2 = p2 * P62_3 + v), (p2 = p2 - (v = (p2 * MAX_INT_INV) | 0) * MAX_INT);
