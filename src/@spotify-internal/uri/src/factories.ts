...
export function applicationURI(id: string, args?: string[]): URITypeDefs.ApplicationURI {
...
export function artistToplistURI(id: string, toplist: string): URITypeDefs.ArtistToplistURI {
...
export function audioFileURI(extension: string, id: string): URITypeDefs.AudioFileURI {
...
export function collectionURI(username: string, category?: string): URITypeDefs.CollectionURI {
...
export function collectionAlbumURI(username: string, id: string): URITypeDefs.CollectionAlbumURI {
...
export function collectionArtistURI(username: string, id: string): URITypeDefs.CollectionArtistURI {
...
export function collectionMissingAlbumURI(username: string, id: string): URITypeDefs.CollectionMissingAlbumURI {
...
export function collectionTrackListURI(username: string, id: string): URITypeDefs.CollectionTrackListURI {
...
export function contextGroupURI(origin: string, name: string): URITypeDefs.ContextGroupURI {
...
export function episodeURI(id: string, context?: string, play?: string): URITypeDefs.EpisodeURI {
...
export function libraryURI(username: string, category?: string): URITypeDefs.LibraryURI {
...
export function localAlbumURI(artist: string, album: string): URITypeDefs.LocalAlbumURI {
...
export function playlistURI(username: string, id: string): URITypeDefs.PlaylistURI {
...
export function profileURI(username: string, args?: string[]): URITypeDefs.ProfileURI {
...
export function publishedRootlistURI(username: string): URITypeDefs.PublishedRootlistURI {
...
export function temporaryPlaylistURI(origin: string, data: string): URITypeDefs.TemporaryPlaylistURI {
...
export function toplistURI(toplist: string, country?: string, global?: boolean): URITypeDefs.ToplistURI {
...
export function trackURI(id: string, anchor?: string, context?: string, play?: string): URITypeDefs.TrackURI {
...
export function userToplistURI(username: string, toplist: string): URITypeDefs.UserToplistURI {
...
export function userTopTracksURI(username: string): URITypeDefs.UserTopTracksURI {
