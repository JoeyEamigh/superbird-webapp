...
export function isArtistToplistURI(uri: URI): uri is URITypeDefs.ArtistToplistURI;
...
export function isCollectionAlbumURI(uri: URI): uri is URITypeDefs.CollectionAlbumURI;
export function isCollectionAlbumURI(uri: URI | string): boolean;
export function isCollectionAlbumURI(uri: URI | string): boolean {
  return parseURI(uri)?.type === URITypeMap.COLLECTION_ALBUM;
}

export function isCollectionArtistURI(uri: URI): uri is URITypeDefs.CollectionArtistURI;
export function isCollectionArtistURI(uri: URI | string): boolean;
export function isCollectionArtistURI(uri: URI | string): boolean {
  return parseURI(uri)?.type === URITypeMap.COLLECTION_ARTIST;
}

export function isCollectionMissingAlbumURI(uri: URI): uri is URITypeDefs.CollectionMissingAlbumURI;
...
export function isCollectionTrackListURI(uri: URI): uri is URITypeDefs.CollectionTrackListURI;
...
export function isPublishedRootlistURI(uri: URI): uri is URITypeDefs.PublishedRootlistURI;
...
export function isSocialSessionURI(uri: URI): uri is URITypeDefs.SocialSessionURI;
...
export function isTemporaryPlaylistURI(uri: URI): uri is URITypeDefs.TemporaryPlaylistURI;
...
export function isUserTopTracksURI(uri: URI): uri is URITypeDefs.UserTopTracksURI;
